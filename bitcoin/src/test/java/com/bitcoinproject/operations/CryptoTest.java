...
class CryptoTest {
    ...
    @Test
    void opHash160ShouldHashData() {
        ScriptInterpreter interpreter = new ScriptInterpreter();
        interpreter.execute("5 OP_HASH160");
    }

    @Test
    void opHash256ShouldHashData() {
        ScriptInterpreter interpreter = new ScriptInterpreter();
        interpreter.execute("5 OP_HASH256");
    }

    @Test
    void opSha256ShouldFailOnEmptyStack() {
        ScriptInterpreter interpreter = new ScriptInterpreter();
